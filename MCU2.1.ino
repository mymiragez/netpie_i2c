...
const char* ssid     = "Tonkaow_2.4G";        // ชื่อ ssid
const char* password = "K@ow0931401566";    // รหัสผ่าน wifi
const char* mqtt_server = "broker.netpie.io";
const int mqtt_port = 1883;
const char* mqtt_client = "4f6cb0a2-1e28-4af8-a1da-8c389dd98826";
const char* mqtt_username = "KHiqFiaKKiKtpzVjU9NQTb1aHfjjyXKa";
const char* mqtt_password = "Va3vbcwDSMa5T823zycCPHC8JL41A7Et";
